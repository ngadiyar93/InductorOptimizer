...
settings.J = 10; % Max current density in A/mm^2
...
% AWG is dimensionless; rest are in units of
% [m]
boundsLo = [1e-3,  2.5e-3, 3e-3, 6e-3, 4e-3, 3e-3, 0.5, 18]; % Lower bounds
boundsHi = [6e-3, 9e-3, 10e-3, 15e-3, 10e-3, 10e-3, 5, 42];% Upper Bounds
